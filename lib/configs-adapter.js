...
exports.updateGoogleCredentials = function(newGoogleCredentials) {
    Object.assign(googleCredentials, newGoogleCredentials);
    var jsonCredentials = JSON.stringify(googleCredentials);
...
exports.updateJiraCredentials = function(newJiraCredentials) {
    Object.assign(jiraCredentials, newJiraCredentials);
    var jsonCredentials = JSON.stringify(jiraCredentials);
...
exports.updateAwsSettings = function(newAwsSettings) {
    Object.assign(awsSettings, newAwsSettings);
    var yamlSettings = yaml.safeDump(awsSettings);
...
exports.updateDatabaseSettings = function(newDatabaseSettings) {
    Object.assign(databaseSettings, newDatabaseSettings);
    var yamlSettings = yaml.safeDump(databaseSettings);
