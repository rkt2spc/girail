...
var DropSignal = require('./DropSignal');
var RequeueSignal = require('./RequeueSignal');
...
var errors = [
    ...
    new DropSignal({ code: 'DS002', message: 'Invalid message, invalid mailbox ${message.mailbox}' }),
    ...
    new DropSignal({ code: 'DS005', message: 'Message doesn\'t have valid Ccs' }),
    new DropSignal({ code: 'DS006', message: 'Message was duplicated' }),
    new DropSignal({ code: 'DS007', message: 'Message was already processed' }),
    
    // Requeue Signal
    new RequeueSignal({ code: 'RS001', message: 'No reply source mapping. SQS could be sending message out-of-order. Try re-enqueueing' }),
