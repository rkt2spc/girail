...
exports.createIssue = function (message, callback) {
    ...
    var promise = new Promise((fulfill, reject) => {
        ...
        // Ugly hack, coudld be remove in fure with proper Jira configs
        if (jiraSettings.fields['Brand'] && !issueFields[jiraSettings.fields['Brand']])
            issueFields[jiraSettings.fields['Brand'].id] = { value: 'White Label' };
