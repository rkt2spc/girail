...
if (!newAwsSettings.region)
    newAwsSettings.region = 'us-west-2';

if (!newAwsSettings.api_version)
    newAwsSettings.api_version = '2012-11-05';

if (!newAwsSettings.queue_url)
    throw (new Error('AWS Settings: queue_url required!'));
